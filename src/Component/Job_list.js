                ...
                <div className="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div className="tab-content">
                        <div id="tab-1" className="tab-pane fade show p-0 active">
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div className="d-flex mb-3">
                                            <Link className="btn btn-light btn-square me-3" to=""><i className="far fa-heart text-primary"></i></Link>
                                            <Link className="btn btn-primary" to="">Apply Now</Link>
                                        </div>
                            ...
                            <Link className="btn btn-primary py-3 px-5" to="">Browse More Jobs</Link>
                        </div>
